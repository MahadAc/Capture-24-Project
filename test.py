...
import joblib
joblib.dump(clf4, "/content/drive/MyDrive/Veritas - Mahad/random_forrest_model.joblib")
import os
joblib.dump(clf4,"/content/drive/MyDrive/Veritas - Mahad/random_forrest_model.joblib", compress=3)
print(f"Compressed Random Forest: {np.round(os.path.getsize('/content/drive/MyDrive/Veritas - Mahad/random_forrest_model.joblib') / 1024 / 1024, 2) } MB")
